...
class BaseQlearningAgent(ABC):
    ...
    def __init__(self,enviorment,num_episods,max_steps_per_episode,learning_rate,learning_rate_decay,discount_rate,expolaration_decay_rate, min_expolaration_rate,expolration_rate) -> None:
        ...
        self.expolration_rate = expolration_rate
